...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <nav class="text-sm text-gray-500 mb-6">
            ...
            <a href="{{ route('products.index', ['category' => $product->category->slug ?? '']) }}" class="hover:text-amber-600">{{ $product->category->name ?? 'Unknown' }}</a> /
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div>
                ...
                <div class="border-t pt-6">
                    <p class="text-gray-600"><strong>Category:</strong> {{ $product->category->name ?? 'Unknown' }}</p>
