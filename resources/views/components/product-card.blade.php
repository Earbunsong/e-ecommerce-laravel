    ...
    <div class="relative">
        <a href="{{ route('products.show', $product['id']) }}">
            <div class="h-48 w-full bg-gradient-to-br from-gray-100 to-gray-200 rounded-t-lg flex items-center justify-center">
                <i class="fas fa-{{ $product['category'] === 'Laptops' ? 'laptop' : ($product['category'] === 'Desktops' ? 'desktop' : ($product['category'] === 'Accessories' ? 'mouse' : ($product['category'] === 'Monitors' ? 'tv' : 'print'))) }} text-6xl text-gray-400"></i>
            </div>
        </a>
